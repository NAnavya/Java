...
public class EmpDaoImpl implements EmpDao{
	...
	public void update(int eno, Emp e) throws EmployeeNotFoundException {
		/*
		 * Optional<Emp> empOptional=getEmployee(eno); Emp e1=null;
		 * if(empOptional.isPresent()) { e1=empOptional.get(); } else { throw new
		 * EmployeeNotFoundException("Employee not found"); }
		 */
		/*
		 * Emp e1=getEmployee(eno).orElseThrow(()->new
		 * EmployeeNotFoundException("Employee Not Found")); e1.setName(e.getName());
